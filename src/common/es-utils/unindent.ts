import { commonMinIndentLength } from "./commonMinIndentLength";

/**
 * @description
 * It removes the first and last line of the provided string. From the remaining lines it
 * calculates the common minimum indentation, ignoring empty lines, and then it subtracts it from
 * each non empty line.
 *
...
export function unindent(s: string): string {
    ...
    const minIndentLength = commonMinIndentLength(s);
